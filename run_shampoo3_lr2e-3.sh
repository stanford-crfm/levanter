...
--trainer.checkpointer.base_path  gs://marin-us-central2/scratch/kaiyue/checkpoints/debug_mudam/shampoo_implicit_lr1.6e-2  \
--optimizer.type shampoo3 \
--optimizer.merge_small_dims True \
--trainer.wandb.name shampoo_implicit_lr3.2e-2 \
--trainer.num_train_steps 10001 \
--optimizer.warmup 1000 \
--optimizer.momentum 0.9 \
--optimizer.shampoo_beta 0.98 \
--optimizer.learning_rate 3.2e-2 \
