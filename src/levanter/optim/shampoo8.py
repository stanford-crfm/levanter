...
@OptimizerConfig.register_subclass("shampoo8")
@dataclass
class Shampoo8Config(OptimizerConfig):
    ...
    def build(self, num_train_steps):
        ...
        def optimizer(learning_rate, adam_lr):
            ...
            def muon_transform():
                components = []
                components.append(scale_by_shampoo8(
                    b1=self.momentum,
