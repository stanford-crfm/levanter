...
class Gpt2Attention(StateDictSerializationMixin, eqx.Module):
    ...
    def from_state_dict(self, state_dict: StateDict, prefix: Optional[str] = None) -> "Gpt2Attention":
        ...
        d = {}
        d.update(unflatten_linear_layers(apply_prefix(prefix, "c_attn"), state_dict, self.c_attn, False))
        d.update(unflatten_linear_layers(apply_prefix(prefix, "c_proj"), state_dict, self.c_proj, False))
    ...
    def update_state_dict(self, state_dict: StateDict, prefix: Optional[str] = None) -> StateDict:
        ...
        my_dict.update(flatten_linear_layers(apply_prefix(prefix, "c_attn"), self.c_attn, False))
        my_dict.update(flatten_linear_layers(apply_prefix(prefix, "c_proj"), self.c_proj, False))
